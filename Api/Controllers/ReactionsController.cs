...
namespace Api.Controllers
{
    ...
    public class ReactionsController : ControllerBase
    {
        ...
        public async Task<OkResult> AddPostReaction(Guid postId, ReactionType reaction)
        {
        ...
        public async Task<OkResult> UpdatePostReaction(Guid postId)
        {
        ...
        public async Task<OkResult> DeletePostReaction(Guid postId)
        {
        ...
        public async Task<OkResult> AddCommentReaction(Guid commentId, ReactionType reaction)
        {
        ...
        public async Task<OkResult> UpdateCommentReaction(Guid commentId)
        {
        ...
        public async Task<OkResult> DeleteCommentReaction(Guid commentId)
        {
